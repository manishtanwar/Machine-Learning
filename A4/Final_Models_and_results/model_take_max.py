...
X1 = np.genfromtxt("submissione12.csv",delimiter=',',dtype=int)[1:30911]
X2 = np.genfromtxt("submissione16.csv",delimiter=',',dtype=int)[1:30911]
X3 = np.genfromtxt("submissione20.csv",delimiter=',',dtype=int)[1:30911]
