...
checkpointer = ModelCheckpoint(filepath='cnn_models/callback/drop_base4400_bcnt300_bsize512.hdf5', verbose=1, save_best_only=True)
...
model.save('cnn_models/drop_base4400_bcnt300_bsize512')
