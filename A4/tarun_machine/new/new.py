...
checkpointer = ModelCheckpoint(filepath='11.hdf5', verbose=1, save_best_only=True)
model.fit_generator(generator = training_generator, validation_data=(X_test, Y_test), callbacks=[checkpointer], epochs=1, class_weight=class_weight, use_multiprocessing=True, workers=6)
model.save('11')
